...
namespace Logica.Clases {
    ...
    public partial class LogicaUsuario : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(LogicaUsuario).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(LogicaUsuario));
        ...
        private string FindResource() {
            string[] resources = typeof(LogicaUsuario).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".LogicaUsuario.g.xaml") || resource.Equals("LogicaUsuario.g.xaml"))) {
                    return resource;
                }
            }
